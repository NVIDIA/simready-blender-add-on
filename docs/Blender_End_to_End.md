...
- [Introduction](#introduction)
   ...
   - [SimReady Foundations Overview](#simready-foundations-overview)
...
- [DCC Blender \-\> SimReady](#creators-workflow-dcc-blender---simready)
   ...
   - [Extended Features Setup](#extended-features-setup)
      ...
      - [Set up Canonical Grasp(s) \- FET_005](#set-up-canonical-grasps---fet_005)
...
* The **Sample Assets** library is a small repository of ready-made SimReady assets. These assets provide a starting reference for how to create assets.
  ...
  ![image1](doc_images/image1.png){w=800px}
...
<a href="https://nvidia.github.io/simready-foundation/guides/guides.html" target="_blank" rel="noopener noreferrer">SimReady Foundation guides</a>
  ...
  * Review the **Profile**, **Features**, **Capabilities**, and **Requirements** for details around each aspect.
  ...
  ![image2](doc_images/image2.png){w=800px}
...
2. Follow the default installation instructions.
   ...
   ![image4](doc_images/image4.png){w=800px}
...
#### Launch Blender
   ...
   ![image5](doc_images/image5.png){w=800px}
...
2. Open **Blender Preferences**.
   ...
   ![image6](doc_images/image6.png){w=800px}

3. Click **Edit (1)**.  
4. Click **Preferences… (2)**.

   ![image7](doc_images/image7.png){w=800px}

5. Click **Add-ons (1)**.  
6. Click the down arrow **(2)** on the top right corner of the window, adjacent to tag icon. ![image9](doc_images/image9.png){w=24px}
...
1. Go to **Edit\->Preferences** in the menu bar at the top of the Blender interface.
   ...
   ![image11](doc_images/image11.png){w=800px}

2. In the **Preferences** window, click **Add-ons (1)** on the left side.  
3. Find the **SimReady_Blender_Core** add-on in the main panel **(2)** and click its expansion icon. ![image12](doc_images/image12.png){w=24px} 
...
You now need to link the **SimReady Blender CORE** to **SimReady Foundation** functions so its tools can use the Foundation's services.
   ...
   ![image13](doc_images/image13.png){w=800px}

4. Click the expansion icon to expand the **SimReady_Blender_Core** preferences. **(1)**
5. Click the folder icon **(2)** ![image14](doc_images/image14.png){w=24px} in **General Settings** (the folder icon inside a red rectangle) to open a file picker to navigate to `project_config.toml`.  

   ![image15](doc_images/image15.png){w=800px}

6. Locate the `project_config.toml` file located at `<foundations>\sample_content\project_config.toml`. **(1)**  
7. Click **Accept. (2)**

   ![image16](doc_images/image16.png){w=800px}  
...
![image17](doc_images/image17.png){w=800px}  
...
Use this procedure if you need to uninstall the SimReady Blender Add-on.
   ...
   ![image19](doc_images/image19.png){w=800px}

1. [Start / Open Blender 5.1](#launch-blender).  
2. Click **Edit (1)** then...
3. Click **Preferences (2)** to open the **Preferences** window.

   ![image18](doc_images/image18.png){w=800px}

4. Select **Add-ons**. **(1)**

   ![image18b](doc_images/image18b.png){w=800px}

5. Find the **SimReady_Blender_Core** add-on **(2)** and click the expand arrow: ![image20](doc_images/image20.png){w=24px}

   ![image21](doc_images/image21.png){w=800px}
...
![image22](doc_images/image22.png){w=800px}
...
![image23](doc_images/image23.png){w=800px}
...
2. In the CORE Artist tools UI, look for **Asset Mgmt -> Make Source Art Directory** section. Click the folder icon ![image24](doc_images/image24.png){w=40px} under **Choose parent directory**. **(2)** 

   ![image25](doc_images/image25.png){w=800px}
...
4. Click “**Select Directory**” **(2)**.
   ...
   ![image26](doc_images/image26.png){w=800px}
...
1. Go to **File \-\> Open** in Blender.
   ...
   ![image27](doc_images/image27.png){w=800px}
...
![image28](doc_images/image28.png){w=800px} 
...
![image29](doc_images/image29.png){w=800px}

1. Make sure your orange object or mesh is selected, and then click the **Materials Properties** tab **(1)** ![image30](doc_images/image30.png){w=24px} in the **Properties** panel. This icon symbolizes Blender’s material context.
2. The orange mesh only has one material assigned to it: ***opaque__organic__orange_01***. Select the material by clicking where the red #2 arrow indicates in the **Properties** panel in the upper right **(2)**. When selected, you can view this material’s attributes lower down in the panel (follow the green arrow).
   ...
   ![image31](doc_images/image31.png){w=800px}
...
![image32](doc_images/image32.png){w=800px}
...
![image33](doc_images/image33.png){w=800px}
...
![image34](doc_images/image34.png){w=800px}
...
1. In the 3D View, press the **N-key** to bring up the side menu, or click in the upper-right of the 3D View to open the side panel. Select the **`CORE`** panel within it **(1)**. 
   ...
   ![image35](doc_images/image35.png){w=800px}
...
2. Toward the middle of the panel is a section called **Usd PhysicsJoint Attributes.** The first item in that section is the **Is uni-body**? checkbox **(1)**. Ensure this checkbox is selected (checked).
   ...
   ![image36](doc_images/image36.png){w=800px}
...
4. Choose the mesh that represents the object **(2)**. To select the object (the orange asset), follow the steps below.
   ...
   ![image37](doc_images/image37.png){w=800px}
   ...
   - You can click the eyedropper icon ![image38](doc_images/image38.png){w=24px} and click the orange in the viewport **(2)**. The eyedropper is in the selection box on the far right, but disappears if you choose a mesh.

![image39](doc_images/image39.png){w=800px}  
![image40](doc_images/image40.png){w=800px}
...
![image41](doc_images/image41.png){w=800px}
...
2. Click **Create Grasp Points (2)**.  
   - Grasp points come as a pair: two points on opposite sides of the object and a line between them. 
     ...
     ![image42](doc_images/image42.png){w=800px}
...
3. Position the grasp line:
   ...
   ![image43](doc_images/image43.png){w=800px}
...
5. When it is active, click the green **EXPORT SIMREADY** button **(2)**.  
   ...
   ![image47](doc_images/image47.png){w=800px}
